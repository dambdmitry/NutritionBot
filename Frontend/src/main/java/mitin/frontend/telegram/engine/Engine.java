...
import mitin.frontend.telegram.constant.diet.DietMenu;
import mitin.frontend.telegram.constant.diet.DietTypes;
import mitin.frontend.telegram.constant.diet.MealTime;
import mitin.frontend.telegram.constant.menu.Menu;
import mitin.frontend.telegram.constant.menu.NavigationMenu;
import mitin.frontend.telegram.constant.user.UserParameters;
import mitin.frontend.telegram.engine.diets.DietService;
...
public class Engine implements BotEngine {
    ...
    private mitin.backend.system.diet.model.menu.day.time.MealTime createMealTime(String key) {
        switch (key) {
            case MealTime.BREAKFAST:
                return mitin.backend.system.diet.model.menu.day.time.MealTime.BREAKFAST;
            case MealTime.FIRST_SNACK:
                return mitin.backend.system.diet.model.menu.day.time.MealTime.FIRST_SNACK;
            case MealTime.DINNER:
                return mitin.backend.system.diet.model.menu.day.time.MealTime.DINNER;
            case MealTime.SECOND_SNACK:
                return mitin.backend.system.diet.model.menu.day.time.MealTime.SECOND_SNACK;
            case MealTime.EVENING_MEAL:
                return mitin.backend.system.diet.model.menu.day.time.MealTime.SUPPER;
            default:
                return mitin.backend.system.diet.model.menu.day.time.MealTime.SUPPER;
        }
    }
